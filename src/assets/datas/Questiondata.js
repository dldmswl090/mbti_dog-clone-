...
export const QuestionData = [
    {
      ...
      {
        id: 2,
        title: "강아지에 대한 모든 것이 궁금해졌다. 나의 행동은?",
        answera:
          "강아지 관련 커뮤니티에 들어 다른 주인님들과 소통을 하며 강아지에 대한 지식을 쌓는다.",
        answerb:
      ...
      {
        id: 3,
        title: "아무리봐도 우리 강아지가 정말 이쁜 것 같다. 나의 행동은?",
        answera:
          "'밤톨이 너무 이쁜 것 같아.. 사람들한테 자랑해야지..!!'하며 인스타를 만들어서 사진도 공유하고 소통도 한다.",
        answerb: "우리 강아지 너무 이쁘다.. 사진찍어서 사진첩에 간직한다.",
        type: "EI",
      },
      {
        id: 4,
      ...
      },
      {
        id: 5,
        title:
          "강아지에 대해서 모르는 부분들을 검색을 하고 있다. 내가 글을 읽는 방법은?",
      ...
      {
        id: 7,
        title: "나처럼 강아지를 키우고 있는 친구가 강아지가 아픈 것 같아 슬퍼하고있다. 나의 반응은?",
        answera:
      ...
      {
        id: 8,
        title: "강아지를 키우는데 가족과의 마찰이 생겼다. 이럴땐?",
        answera:
      ...
      {
        id: 10,
        title: "강아지 사료를 급여하는 방법은?",
        answera:
          "'우리 강아지 몸무게는 5키로니까 하루세번 몇시에 이만큼 씩 주고, 간식은 이때 챙겨줘야겠다. 영양제도 미리미리 챙겨줘야지!' 계획을 세운다. ",
        answerb: "사료주면 알아서 먹겠지! 일단 자율급식으로 한꺼번에 줘본다.",
        type: "JP",
      },
      {
        id: 11,
        title: "강아지 사료가 우연히 여러 종류가 생겼다. 급여방법은?",
        answera:
          "사료를 조금씩 급여해서 강아지의 기호를 테스트 해보고 다 잘먹는다면 날짜에 맞춰서 질리지 않도록 바꿔가며  급여한다.",
